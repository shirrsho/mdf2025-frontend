      ...
      <div className='mx-auto max-w-7xl'>
        ...
        <div className='mb-16 text-center'>
          ...
          <p className='mx-auto max-w-2xl text-lg text-gray-300'>
            Join the largest digital job fair platform and be part of our
            success story.
          </p>
        </div>
        ...
        <div className='mt-20 rounded-2xl bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 p-8 text-center'>
          ...
          <p className='mx-auto max-w-2xl text-gray-300'>
            Recognized as the &quot;Best Digital Recruitment Platform 2024&quot;
            by TechRecruitment Awards and featured in Forbes as a game-changer
