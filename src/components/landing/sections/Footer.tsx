...
export const Footer: React.FC = () => {
  return (
    <footer className='bg-background-300 border-t border-background-200'>
      {/* Newsletter Section */}
            ...
            <div className='flex flex-col space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0'>
              <div className='flex-1'>
                <input
                  ...
                  className='w-full rounded-lg bg-background-200 border border-background-100 px-4 py-3 text-white placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary'
                />
              </div>
              <Button 
                type='primary' 
                size='large'
                className='bg-primary border-primary hover:bg-primary-400'
      ...
      <div className='px-4 py-16'>
        <div className='mx-auto max-w-7xl'>
          <div className='grid gap-8 lg:grid-cols-5'>
            ...
            <div className='lg:col-span-2'>
              <div className='mb-6'>
                ...
                <p className='mt-4 text-gray-400'>
                  ...
                  Join thousands of job seekers and employers in the digital revolution of recruitment.
                </p>
              </div>
            ...
            <div>
              <h3 className='mb-4 text-lg font-semibold text-white'>Job Seekers</h3>
              <ul className='space-y-2'>
            ...
            <div>
              <h3 className='mb-4 text-lg font-semibold text-white'>Employers</h3>
              <ul className='space-y-2'>
