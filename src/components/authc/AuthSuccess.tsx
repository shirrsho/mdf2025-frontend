      ...
      <div className='rounded-lg border border-background-200 bg-background-300 px-10 py-8 shadow-lg sm:mx-auto sm:w-full sm:max-w-sm'>
        <div className='space-y-6'>
          ...
          <Link
            ...
            className='flex transform justify-center rounded-md border-primary bg-primary px-4 py-3 text-white transition-colors duration-200 hover:bg-primary-400 focus:bg-primary-500 focus:outline-none'
          >
            Continue
          </Link>
        </div>
