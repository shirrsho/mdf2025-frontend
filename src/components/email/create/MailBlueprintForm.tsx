...
import { AppRichTextInput } from '@/components/common';
...
export const MailBlueprintForm: React.FC<MailBlueprintFormProps> = ({
  form,
  onFinish,
}) => {
  ...
  const [bodyContent, setBodyContent] = useState<string>(
    form.getFieldValue('bodyContent')
  );
  ...
  return (
    <>
      <Form form={form} layout='vertical' onFinish={onFinish} className='mt-4'>
        ...
        <Form.Item name='resourceName' hidden />
        <Form.Item
          name='name'
          label={
        ...
        >
          <Input
            ...
            className='rounded-lg dark:border-background-dark-300 dark:bg-background-dark-200 dark:text-paragraph-dark'
